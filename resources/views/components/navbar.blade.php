                    ...
                    @auth
                        ...
                        <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-blue-700">
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                                <li>
                                    <a href="{{ route('usuario.mantenimientos') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-blue-600 dark:hover:text-white">Mantenimientos</a>
                                </li>
                                <li>
                                    <a href="{{ route('usuario.autos') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-blue-600 dark:hover:text-white">Autos</a>
                                </li>
                                <li>
                                    <a href="{{ route('usuario.anadir-auto') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-blue-600 dark:hover:text-white">Añadir autos</a>
                                </li>
                                <li>
