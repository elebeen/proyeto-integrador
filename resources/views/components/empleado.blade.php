    ...
    <body class="font-sans text-gray-900 antialiased">
        ...
        <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('citas.filtros') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 focus-within:bg-gray-400 dark:focus-within:bg-gray-700 group">
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 focus-within:bg-gray-400 dark:focus-within:bg-gray-700 group">
                        <x-gear class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"></x-gear>
                ...
                <li>
                    <form action="{{ route('empleado.logout') }}" method="POST">
                        @csrf 
                        <button type="submit" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-red-600 dark:hover:bg-red-600 group">
