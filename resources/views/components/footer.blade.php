<footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            ...
            <div class="mb-6 md:mb-0">
                <a href="#" class="flex items-center">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">VIP2CARS</span>
                </a>
            </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 VIP2CARS. Todos los derechos reservados.</span>
            ...
            <div class="flex mt-4 sm:justify-center sm:mt-0">
                ...
                <a href="https://discordapp.com/channels/1216921530848772126/1216921530848772129" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                    ...
                    <span class="sr-only">Comunidad Discord</span>
                </a>
                <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
