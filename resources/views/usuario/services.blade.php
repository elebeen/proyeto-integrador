    ...
    <section class="p-8 bg-white">
        <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div class="service-card transform transition hover:scale-105 duration-300 bg-gray-100 p-6 rounded-lg shadow-md relative">
                ...
                <a href="{{ route('usuario.cita-formulario', ['categoria' => 'Mecanica']) }}" class="bg-red-600 text-white font-bold py-2 px-4 rounded-md hover:bg-red-700 transition mt-4 inline-block">Crear Cita</a>            
            </div>
            ...
            <div class="service-card transform transition hover:scale-105 duration-300 bg-gray-100 p-6 rounded-lg shadow-md relative">
                ...
                <a href="{{ route('usuario.cita-formulario', ['categoria' => 'Planchado']) }}" class="bg-red-600 text-white font-bold py-2 px-4 rounded-md hover:bg-red-700 transition mt-4 inline-block">Crear Cita</a>
            </div>
            ...
            <div class="service-card transform transition hover:scale-105 duration-300 bg-gray-100 p-6 rounded-lg shadow-md relative">
                ...
                <a href="{{ route('usuario.cita-formulario', ['categoria' => 'Electricidad']) }}" class="bg-red-600 text-white font-bold py-2 px-4 rounded-md hover:bg-red-700 transition mt-4 inline-block">Crear Cita</a>            
            </div>
            ...
            <div class="service-card transform transition hover:scale-105 duration-300 bg-gray-100 p-6 rounded-lg shadow-md relative">
                ...
                <a href="{{ route('usuario.cita-formulario', ['categoria' => 'Preventivo']) }}" class="bg-red-600 text-white font-bold py-2 px-4 rounded-md hover:bg-red-700 transition mt-4 inline-block">Crear Cita</a>            
            </div>

            <div class="service-card transform transition hover:scale-105 duration-300 bg-gray-100 p-6 rounded-lg shadow-md relative">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMS64FGB2av5GriiTgAMsd9UwVdIUBpouJRw&s" alt="Todos los servicios" class="w-full h-48 object-cover rounded-t-md mb-4">
                <h3 class="text-2xl font-semibold mb-2">Todos los Servicios</h3>
                <p class="text-gray-600 mb-4">Incluye todos los servicios que pueden ser ofrecidos a tu auto</p>
                <a href="{{ route('usuario.cita-formulario', ['categoria' => 'General']) }}" class="bg-red-600 text-white font-bold py-2 px-4 rounded-md hover:bg-red-700 transition mt-4 inline-block">Crear Cita</a>            
            </div>
